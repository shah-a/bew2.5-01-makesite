...
[![Go Report Card](https://goreportcard.com/badge/github.com/shah-a/bew2.5-01-makesite)](https://goreportcard.com/report/github.com/shah-a/bew2.5-01-makesite)
...
- [x] Add any third party library to your project to enhance it's functionality. Some ideas you might consider include **_(CHOOSE ONLY ONE)_**:
    ...
    - [x] **_FILL IN THE BLANK_**: `I will use the github.com/fatih/colors library. The documentation is located at https://pkg.go.dev/github.com/fatih/color. My goal is to use it to colour terminal output green and red accordingly for success and error messages.`
- [x] **Add, commit, and push to GitHub**.
